...
class Category {
    ...
    public static function getCategoryListAdmin () {
        ...
        $sql = "SELECT id, parent_id, name, sort_order, status FROM category
                ORDER BY sort_order ASC";
    ...
    public static function addCategory ($options) {
        ...
        $sql = "
                ...
                VALUES (:parent_id, :name, :sort_order, :status)
                ";

        $res = $db->prepare($sql);
        $res->bindParam(':parent_id', $options['parent_id'], PDO::PARAM_INT);
    ...
    public static function getCategoryById ($id) {
        ...
        $sql = "SELECT parent_id, name, sort_order, status FROM category
                WHERE id = :id";
